...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::get('districts', 'App\Http\Controllers\Api\V2\AddressController@getDistricts');
    ...
    Route::get('districts-by-city/{city_id}', 'App\Http\Controllers\Api\V2\AddressController@getDistrictsByCity');
