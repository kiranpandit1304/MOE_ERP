...
use App\Http\Controllers\SellerBulkUploadController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::controller(SellerBulkUploadController::class)->group(function () {
        //Seller Bulk Upload
        Route::get('/seller-bulk-upload/index', 'index')->name('seller_bulk_upload.index');
        Route::post('/bulk-seller-upload', 'bulk_upload')->name('bulk_seller_upload');
        Route::get('/seller-csv-download/{type}', 'import_seller')->name('seller_csv.download');
    });
