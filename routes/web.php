...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/sellers/{category_slug}', 'sellerListingByCategory')->name('sellersByCategory');
...
Route::controller(CustomerProductController::class)->group(function () {
    ...
    Route::get('/customer-products?district={district_id}', 'search')->name('customer_products.district');
...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::controller(AddressController::class)->group(function () {
        ...
        Route::post('/get-districts', 'getDistricts')->name('get-district');
