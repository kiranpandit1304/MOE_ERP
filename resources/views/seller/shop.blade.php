        ...
        <div class="card-body">
            <form class="" action="{{ route('seller.shop.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <input type="number" class="form-control mb-3" placeholder="{{ translate('Phone')}}" name="phone" value="{{ $shop->phone }}" max=999999999999 required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">
                        <label>{{ translate('Shop Mobile') }}</label>
                    </div>
                    <div class="col-md-10">
                        <input type="number" class="form-control mb-3" placeholder="{{ translate('Mobile')}}" name="mobile" value="{{ $shop->mobile }}" max=999999999999>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">
                        <label>{{ translate('Shop WhatsApp') }}</label>
                    </div>
                    <div class="col-md-10">
                        <input type="number" class="form-control mb-3" placeholder="{{ translate('WhatsApp')}}" name="whatsapp" value="{{ $shop->whatsapp }}" max=999999999999>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <select class="form-control mb-3 aiz-selectpicker rounded-0" data-live-search="true" name="district_id" required>
                            @foreach ($districts as $key => $district)
                                <option value="{{ $district->id }}" @if($shop->district_id == $district->id) selected @endif>
                                    {{ $district->name }}
                                </option>
                            @endforeach
                        </select>
            ...
            <form class="" action="{{ route('seller.shop.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-box-content p-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" placeholder="https://yourwebsite.com" name="website" value="{{ $shop->website }}">
                            <small class="text-muted">{{ translate('Insert link with https ') }}</small>
                        </div>
                    </div>
                </div>
