...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">{{translate('Seller Bulk Upload')}}</h5>
        </div>
        <div class="card-body">
            <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                ...
                <p>4. {{translate('After uploading sellers you need to edit them and set seller\'s images and choices')}}.</p>
            </div>
            <br>
            <div class="">
                <a href="{{ static_asset('download/seller_bulk_demo.xlsx') }}" download><button class="btn btn-info">{{ translate('Download CSV')}}</button></a>
            </div>
            <br>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6"><strong>{{translate('Upload Seller File')}}</strong></h5>
        </div>
        <div class="card-body">
