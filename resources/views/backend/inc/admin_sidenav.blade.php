    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <!-- Car rental -->
                @canany(['add_car_models', 'add_car_brands','show_all_models','show_all_brands'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-shopping-cart aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{translate('Car Rental')}}</span>
                            ...
                            @can('add_car_models')
                                <li class="aiz-side-nav-item">
                                    <a class="aiz-side-nav-link" href="{{route('products.create')}}">
                                        <span class="aiz-side-nav-text">{{translate('Add New Model')}}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('show_all_models')
                ...
                <!-- Sellers -->
                @canany(['view_all_seller','seller_payment_history','view_seller_payout_requests','seller_commission_configuration','view_all_seller_packages','seller_verification_form_configuration','seller_bulk_import'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endcan
                            @can('seller_bulk_import')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('seller_bulk_upload.index') }}" class="aiz-side-nav-link" >
                                        <span class="aiz-side-nav-text">{{ translate('Bulk Import') }}</span>
                                    </a>
                                </li>
                            @endcan
                ...
                @canany(['general_settings','features_activation','language_setup','currency_setup','vat_&_tax_setup',
                        ...
                        'google_firebase_setting','shipping_configuration','shipping_country_setting','manage_shipping_states','manage_shipping_cities','manage_shipping_districts','manage_zones','manage_carriers'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endcanany
                            @canany(['shipping_configuration','shipping_country_setting','manage_shipping_states','manage_shipping_cities','manage_shipping_districts','manage_zones','manage_carriers'])
                                <li class="aiz-side-nav-item">
                                    <a href="javascript:void(0);" class="aiz-side-nav-link">
