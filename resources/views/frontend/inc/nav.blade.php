        ...
        <div class="row">
            ...
            <div class="col-lg-6 col">
                <ul class="list-inline d-flex justify-content-between justify-content-lg-end mb-0">
                    ...
                    <li class="list-inline-item dropdown mx-4" id="lang-change">
                        @php
...
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white">
                    ...
                    <div class="position-relative flex-grow-1 px-3 px-lg-0">
                        <form action="{{ route('search') }}" method="GET" class="stop-propagation">
                            <div class="d-flex position-relative align-items-center">
                                ...
                                @php
                                    $cities = \App\Models\City::where('status', 1)->with('districts')->get();
                                @endphp
                                <div class="search-input-box">
                                <div class="input-group">
                                        <input type="text" class="col-6 border border-soft-light form-control fs-14 hov-animate-outline" id="search" name="keyword" @isset($query)
                                            value="{{ $query }}" @endisset placeholder="{{translate('I am shopping for...')}}" autocomplete="off">
                                        <div class="col-6 w-100 px-0 input-group-append">
                                            <select class="w-100 fs-14 hov-animate-outline aiz-selectpicker" data-live-search="true" name="location" required onchange="this.form.submit()"
                                            @if(Session::has('city_id') && Session::get('city_id') != null)
                                                data-selected="city-{{ Session::get('city_id') }}"
                                            @elseif(Session::has('district_id') && Session::get('district_id') != null)
                                                data-selected="district-{{ Session::get('district_id') }}"
                                            @endif
                                            >
                                                @php
                                                foreach($cities as $city){
                                                    if($city->districts->count() > 0)
                                                    {
                                                        foreach($city->districts as $district){
                                                            @endphp
                                                            <option value="district-{{ $district->id }}">
                                ...
                                <!-- <div class="search-input-box">
                                    <select class="border border-soft-light form-control fs-14 hov-animate-outline aiz-selectpicker rounded-3" data-live-search="true" name="location" required>
                                        @php
                                        foreach($cities as $city){
                                            if($city->districts->count() > 0)
                                            {
                ...
                <div class="ml-auto mr-0">
                    ...
                    @else
                        ...
                        <span class="d-none d-xl-flex align-items-center nav-user-info ml-3">
                            <a href="#" onclick="$('#login_modal').modal('show');" class="text-reset opacity-60 hov-opacity-100 hov-text-primary fs-12 d-inline-block">
                            ...
                            <!-- <a href="{{ route('user.registration') }}" class="text-reset opacity-60 hov-opacity-100 hov-text-primary fs-12 d-inline-block py-2 pl-2"></a> -->
                        </span>
                    @endauth
                </div>
            </div>
    ...
    <div class="d-none d-lg-block position-relative bg-primary h-50px">
        <div class="container h-100 p-0" style="max-width:100%">
        ...
        <div class="hover-category-menu position-absolute w-100 top-100 left-0 right-0 z-3 d-none" id="click-category-menu">
            <div class="container p-0" style="max-width:inherit">
