                    ...
                    <div class="col-xl-3">
                        <div class="aiz-filter-sidebar collapse-sidebar-wrap sidebar-xl sidebar-right z-1035">
                            ...
                            <div class="collapse-sidebar c-scrollbar-light text-left">
                                    ...
                                    <div class="p-3 mr-3">
                                        <div class="aiz-range-slider">
                                            <div
                                                ...
                                                data-range-value-min="@if(\App\Models\Product::where('published', 1)->count() < 1) 0 @else {{ \App\Models\Product::where('published', 1)->min(DB::raw('(unit_price - discount)')) }} @endif"
                                                data-range-value-max="@if(\App\Models\Product::where('published', 1)->count() < 1) 0 @else {{ \App\Models\Product::where('published', 1)->max(DB::raw('(unit_price - discount)')) }} @endif"
                                            ></div>
                                ...
                                <!-- Attributes -->
                                @if(isset($category_id) || isset($query))
