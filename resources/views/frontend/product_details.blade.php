            ...
            <div class="bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 mb-4">
                          <!-- Breadcrumb -->
                            <ul class="breadcrumb bg-transparent py-0 px-1 pb-3">
                                <li class="breadcrumb-item has-transition opacity-50 hov-opacity-100">
                                    <a class="text-reset" href="{{ route('home') }}">{{ translate('Home')}}</a>
                                </li>
                                @if(isset($detailedProduct->category->parentCategory->parentCategory))
                                    <li class="breadcrumb-item opacity-50 hov-opacity-100">
                                        <a class="text-reset" href="{{ route('products.category', $detailedProduct->category->parentCategory->parentCategory->slug) }}">{{ translate($detailedProduct->category->parentCategory->parentCategory->name)}}</a>
                                    </li>
                                @endif
                                @if(isset($detailedProduct->category->parentCategory))
                                    <li class="breadcrumb-item opacity-50 hov-opacity-100">
                                        <a class="text-reset" href="{{ route('products.category', $detailedProduct->category->parentCategory->slug) }}">{{ translate($detailedProduct->category->parentCategory->name)}}</a>
                                    </li>
                                @endif
                                @if(isset($detailedProduct->category))
                                    <li class="text-dark fw-600 breadcrumb-item">
                                    <a class="text-reset" href="{{ route('products.category', $detailedProduct->category->slug) }}">{{ translate($detailedProduct->category->name)}}</a>
                                    </li>
                                @endif
                            </ul>
