...
class AddressController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $data['districts'] = District::where('status', 1)->where('city_id', $data['address_data']->city_id)->get();
...
//        return ;
    ...
    public function getDistricts(Request $request) {
        $districts = District::where('status', 1)->where('district_id', $request->district_id)->get();
