...
class SearchController extends Controller
{
    public function index(Request $request, $category_id = null, $brand_id = null)
    {
        ...
        $city_id = str_contains($location,'city') ? explode('-',$location)[1] : null;
        $district_id = str_contains($location,'district') ? explode('-',$location)[1] : null;
        ...
        if($district_id != null){
            $products->inDistrict($district_id);
        }else if($city_id != null){
            $products->inCity($city_id);
        }
